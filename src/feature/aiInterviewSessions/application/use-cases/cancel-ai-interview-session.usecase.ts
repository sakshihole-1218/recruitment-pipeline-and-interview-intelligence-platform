...
@Injectable()
export class CancelAiInterviewSessionUseCase {
  constructor(
  ...
  async execute(
    ...
    return this.dataSource.transaction(async (manager) => {
      ...
      this.validation.ensureCanCancel(session.session_status);

      session.session_status = AiInterviewSessionStatus.CANCELLED;
