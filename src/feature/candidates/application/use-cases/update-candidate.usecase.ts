...
export class UpdateCandidateUseCase {
  ...
  async execute(
    ...
    if (dto.date_of_birth !== undefined)
      candidate.date_of_birth = dto.date_of_birth ?? null;
    ...
    if (dto.current_company !== undefined)
      candidate.current_company = dto.current_company ?? null;
    if (dto.current_job_title !== undefined)
      candidate.current_job_title = dto.current_job_title ?? null;
    if (dto.current_location !== undefined)
      candidate.current_location = dto.current_location ?? null;
    if (dto.notice_period_days !== undefined)
      candidate.notice_period_days = dto.notice_period_days ?? null;
    ...
    if (dto.currency_code !== undefined)
      candidate.currency_code = dto.currency_code ?? null;
    if (dto.linkedin_url !== undefined)
      candidate.linkedin_url = dto.linkedin_url ?? null;
    if (dto.github_url !== undefined)
      candidate.github_url = dto.github_url ?? null;
    if (dto.portfolio_url !== undefined)
      candidate.portfolio_url = dto.portfolio_url ?? null;
    if (dto.resume_headline !== undefined)
      candidate.resume_headline = dto.resume_headline ?? null;
    if (dto.source_type !== undefined)
      candidate.source_type = dto.source_type ?? null;
    if (dto.source_details !== undefined)
      candidate.source_details = dto.source_details ?? null;
