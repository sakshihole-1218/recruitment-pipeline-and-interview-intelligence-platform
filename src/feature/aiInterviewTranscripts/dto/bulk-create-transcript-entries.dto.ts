...
export class BulkCreateTranscriptEntryItemDto {
...
export class BulkCreateTranscriptEntriesDto {
  @ApiProperty({ description: 'AI interview session UUID' })
  @IsUUID()
  ai_interview_session_id: string;

  @ApiProperty({ type: [BulkCreateTranscriptEntryItemDto] })
  @IsArray()
  @ArrayMinSize(1)
  @ValidateNested({ each: true })
  @Type(() => BulkCreateTranscriptEntryItemDto)
